...
const Mycart = () => {
    return (
        <div className="mt-16 mx-auto flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-50 text-gray-800">
                        ...
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-semibold">59.99 taka</p>
                                    <p className="text-sm line-through text-gray-400">75.50 taka</p>
                                </div>
                            </div>
                    ...
                    <div className="flex w-full space-x-2 sm:space-x-4">
                        ...
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-semibold">99.95 taka</p>
                                    <p className="text-sm line-through text-gray-400">150 taka</p>
                                </div>
                            </div>
                            <div className="flex text-sm divide-x">
                                <button type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
                    ...
                    <div className="flex w-full space-x-2 sm:space-x-4">
                        ...
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-semibold">8.99 taka</p>
                                    <p className="text-sm line-through text-gray-400">15.99 taka</p>
                                </div>
                            </div>
                            <div className="flex text-sm divide-x">
                                <button type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
            ...
            <div className="flex justify-end space-x-4">
                <Link to="/shop">
                <button type="button" className="px-6 py-2 border rounded-md border-[#FF4240]">Back
                    <span className="sr-only sm:not-sr-only">to shop</span>
                </button>
                </Link>
                <button type="button" className="px-6 py-2 border rounded-md bg-[#FF4240] text-gray-50 border-[#FF4240]">
